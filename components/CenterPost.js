function CenterPost({data}) {
    return (
        <div className="bg-white shadow-sm px-5 py-3 rounded-md flex flex-col gap-3">
            <div className="flex items-center gap-5">
                <img className="rounded-full w-12 h-12" src="https://sun1-19.userapi.com/s/v1/ig1/OWRjoSFQYekBQfTq-DOuyBfZ_qc2qHE5mxthMhez1DXU48AW8gxb7_lh0GnTZ9ACmq-FtCGy.jpg?size=50x50&quality=96&crop=112,0,786,786&ava=1" alt="" />
                <div className="">
                    <h4 className="text-md text-[#2a5885]">Гифач | Гифки</h4>
                    <h5 className="text-gray-500 text-sm">today at 10:55 pm</h5>
                </div>
            </div>
            <p className="text-sm font-medium">* Гифки *</p>
            <div className="grid grid-template-post">
                <img src="https://sun1-54.userapi.com/impg/hAtcLzke7yuF-9CQm6oqtNKAcL_l95R8ye2XlA/ukBvfw49GPk.jpg?size=986x1080&quality=96&sign=d9344d15d4d4bdaf23aa350774ab2754&type=album" alt="" className="" />
            </div>
            <div className="flex items-center gap-3 text-gray-500">
                ...
                <button className="flex items-center text-sm gap-1 ml-auto">
                    <svg fill="none" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><g fill="currentColor"><path d="M9.5 8a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"></path><path clip-rule="evenodd" d="M15.5 8c0-1-3-5-7.5-5S.5 7 .5 8s3 5 7.5 5 7.5-4 7.5-5zm-4 0a3.5 3.5 0 11-7 0 3.5 3.5 0 017 0z" fill-rule="evenodd"></path></g></svg>
                    <h5 className="">15K</h5>
                </button>
